...
\textsec{\href{https://ourworldindata.org/coronavirus}{COVID-19}: Producing and curating a global database of COVID-19, used by the WHO and international press (NYT, FT, etc.).}
\sectionsep
...
\textsec{git, mercurial / ssh / docker / GitHub, Bitbucket / unit testing / AB testing / GNU/Linux / CI/CD (Travis, Jenkins) / Google Cloud Platform / numpy, scipy, pandas, dask, sklearn, tensorflow, keras, xgboost, plotly, bokeh / cookiecutter / GPU / Raspberry PI / VS Code / Jira, Trello / Logic Pro / DaVinci Resolve / Blogging}
...
Maintainance and data management of global COVID-19 vaccination dataset.
}
\sectionsep
