...
\textsec{Working on \href{https://ourworldindata.org/coronavirus}{COVID-19 data}}
\sectionsep
...
\textsec{Machine Learning, Deep Learning, Artificial Intelligence, Computer Vision, Information Retrieval, Unix Systems, Digital Signal Processing, Wireless Systems, Information Theory, Probability Theory.}
\sectionsep
...
\textsec{Git/Mercurial, ssh, docker, GitHub/Bitbucket, unit testing, A/B testing, GNU/Linux, CI/CD (Travis, Jenkins), Google Cloud Platform, numpy/scipy, pandas/dask, sklearn, tensorflow/keras, xgboost, plotly/bokeh, cookiecutter, GPU, React Native, Raspberry PI, JetBrains, VS Code, Jira/Confluence, Trello, Adobe Photoshop, Logic Pro, Blogging, DaVinci Resolve, Raspberry PI.}
