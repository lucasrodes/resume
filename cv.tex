...
using Machine Learning. Exploratory data analysis, training/hyper-parameter tuning, productionalisation, testing,
...
review recent approaches to colorize gray-scale images using deep learning methods and propose a novel colorization model.}
\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%     COLUMN 2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
