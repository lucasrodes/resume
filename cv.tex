...
\textsec{Machine Learning, Deep Learning, Artificial Intelligence, Algorithms, Information Retrieval, Unix Systems.}
\sectionsep
%Computer Vision \\
\runsubsection{Electrical Engineering} \\
\textsec{Signals and Systems, Digital Signal Processing, Wireless Systems, Information Theory, Probability, Stochastic Processes.}
\sectionsep
 
\runsubsection{Online courses} \\
\textsec{Digital Signal Processing (Coursera), Python for Everybody (Coursera), Django for Everybody (Coursera), Convolutional Neural Networks for Visual Recognition (Stanford).}
\sectionsep
...
\textsec{Git/Mercurial, ssh, Docker, CI/CD, GitGub/Bitbucket, unit testing, GNU/Linux, MacOS, Google Cloud Platform, CI/CD (Travis, Jenkins), numpy/scipy, pandas, sklearn, tensorflow/keras, xgboost, GPU, react native, raspberry PI, JetBrains, VS Code, Xcode, Jira/Confluence, Trello/Miro, Adobe Photoshop, Logic Pro, Blogging, DaVinci Resolve.}
